  ...
  // craete event api
   const createEventApi = async () => {
    ...
    const res = await fetch(
      `${process.env.REACT_APP_BASE_URL}user/speakerSaveEventCalender`,
      requestKey
    );
    ...
    <Fragment>
                    ...
                    <div className="aum-inner">
                      ...
                      <div className="aum-bot">
                        <div className="aum-left">
                          <div className="aum-name">Sheldon Brick</div>
                          <div className="aum-desg">co-founder</div>
                          <div className="aum-price">$250 - $1,500</div>
                        </div>
                      </div>
                    </div>
                    <div className="aum-inner">
      ...
      >
        <Modal.Header closeButton>
          ...
          <p className="event-title">(This event does not require speakers to pay for speaking)</p>
        </Modal.Header>
                          ...
                          <div className="col-md-6 form-group">
                            <label htmlFor="" className="form-label">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  handleParesentInputChange(e)
                                }
                                className="form-control"
                              />
                          {senderImage && <img style={{width:"100px"}} className="event-image" src={senderImage} alt="uploade"/>}
                          </div>                                                              
        ...
        <Modal.Footer>
          <div className="dual-btn">
            ...
            <div className="sap-btn-light">
              ...
              >
                Submit<span className="btn-loader">
